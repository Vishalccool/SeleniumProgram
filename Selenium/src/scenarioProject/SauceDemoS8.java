...
//S8. Verify whether we are able to check the "About"

public class SauceDemoS8 
{
	...
	public static void main(String[] args) throws IOException, InterruptedException 
	{
        ...
        WebElement option1=alloptions.get(1);  //here about tab's  index is 1
   	    option1.click();
   	 
        System.out.println("about tab opened");
